        ...
        @foreach ($plans as $plan)
            <div class="col">
                <div class="card h-100 shadow-sm border-0">
                    {{-- Farebný pásik s ikonou na vrchu --}}
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            ...
                            {{-- Odkomentuj, ak chceš aj mazanie --}}
                            {{-- <form method="POST" action="{{ route('plans.destroy', $plan->id) }}" onsubmit="return confirm('Naozaj chceš vymazať tento plán?')">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-sm btn-outline-danger" title="Vymazať">
